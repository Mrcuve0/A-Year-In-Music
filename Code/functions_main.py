...
def albumCreation(artistName, albumName, songName, albumFM, allSongs, isTo, device, repetitions, albumOrSong):
...
def AASInfoGathering(artistName, albumName, songName, isTo, allArtists, allAlbums, allSongs, device, repetitions, albumOrSong):
    ...
    if (artistName in str(allArtists.keys())):
        ...
        if (albumName in str(allAlbums.keys())):
            ...
            (album, allSongs) = albumCreation(artistName, albumName, songName, albumFM, allSongs, isTo, device, repetitions, albumOrSong)
